...
#ifdef PC_PORT
#include <stdint.h>
extern uint8_t gIoMem[0x400];
#define _IO_REG8(off) (*(vu8*)(gIoMem + (off)))
#define _IO_REG16(off) (*(vu16*)(gIoMem + (off)))
#define _IO_REG32(off) (*(vu32*)(gIoMem + (off)))
#define _IO_REG64(off) (*(vu64*)(gIoMem + (off)))

/* Display */
#undef REG_DISPCNT
#undef REG_DISPSTAT
#undef REG_VCOUNT
#define REG_DISPCNT _IO_REG16(REG_OFFSET_DISPCNT)
#define REG_DISPSTAT _IO_REG16(REG_OFFSET_DISPSTAT)
#define REG_VCOUNT _IO_REG16(REG_OFFSET_VCOUNT)
...
#undef REG_BG2CNT
#undef REG_BG3CNT
#define REG_BG0CNT _IO_REG16(REG_OFFSET_BG0CNT)
#define REG_BG1CNT _IO_REG16(REG_OFFSET_BG1CNT)
#define REG_BG2CNT _IO_REG16(REG_OFFSET_BG2CNT)
#define REG_BG3CNT _IO_REG16(REG_OFFSET_BG3CNT)
...
#undef REG_BG3HOFS
#undef REG_BG3VOFS
#define REG_BG0HOFS _IO_REG16(REG_OFFSET_BG0HOFS)
#define REG_BG0VOFS _IO_REG16(REG_OFFSET_BG0VOFS)
#define REG_BG1HOFS _IO_REG16(REG_OFFSET_BG1HOFS)
#define REG_BG1VOFS _IO_REG16(REG_OFFSET_BG1VOFS)
#define REG_BG2HOFS _IO_REG16(REG_OFFSET_BG2HOFS)
#define REG_BG2VOFS _IO_REG16(REG_OFFSET_BG2VOFS)
#define REG_BG3HOFS _IO_REG16(REG_OFFSET_BG3HOFS)
#define REG_BG3VOFS _IO_REG16(REG_OFFSET_BG3VOFS)
...
#undef REG_BG2Y_L
#undef REG_BG2Y_H
#define REG_BG2PA _IO_REG16(REG_OFFSET_BG2PA)
#define REG_BG2PB _IO_REG16(REG_OFFSET_BG2PB)
#define REG_BG2PC _IO_REG16(REG_OFFSET_BG2PC)
#define REG_BG2PD _IO_REG16(REG_OFFSET_BG2PD)
#define REG_BG2X _IO_REG32(REG_OFFSET_BG2X)
#define REG_BG2X_L _IO_REG16(REG_OFFSET_BG2X_L)
#define REG_BG2X_H _IO_REG16(REG_OFFSET_BG2X_H)
#define REG_BG2Y _IO_REG32(REG_OFFSET_BG2Y)
#define REG_BG2Y_L _IO_REG16(REG_OFFSET_BG2Y_L)
#define REG_BG2Y_H _IO_REG16(REG_OFFSET_BG2Y_H)
...
#undef REG_BG3Y_L
#undef REG_BG3Y_H
#define REG_BG3PA _IO_REG16(REG_OFFSET_BG3PA)
#define REG_BG3PB _IO_REG16(REG_OFFSET_BG3PB)
#define REG_BG3PC _IO_REG16(REG_OFFSET_BG3PC)
#define REG_BG3PD _IO_REG16(REG_OFFSET_BG3PD)
#define REG_BG3X _IO_REG32(REG_OFFSET_BG3X)
#define REG_BG3X_L _IO_REG16(REG_OFFSET_BG3X_L)
#define REG_BG3X_H _IO_REG16(REG_OFFSET_BG3X_H)
#define REG_BG3Y _IO_REG32(REG_OFFSET_BG3Y)
#define REG_BG3Y_L _IO_REG16(REG_OFFSET_BG3Y_L)
#define REG_BG3Y_H _IO_REG16(REG_OFFSET_BG3Y_H)
...
#undef REG_WINOUT
#undef REG_MOSAIC
#define REG_WIN0H _IO_REG16(REG_OFFSET_WIN0H)
#define REG_WIN1H _IO_REG16(REG_OFFSET_WIN1H)
#define REG_WIN0V _IO_REG16(REG_OFFSET_WIN0V)
#define REG_WIN1V _IO_REG16(REG_OFFSET_WIN1V)
#define REG_WININ _IO_REG16(REG_OFFSET_WININ)
#define REG_WINOUT _IO_REG16(REG_OFFSET_WINOUT)
#define REG_MOSAIC _IO_REG16(REG_OFFSET_MOSAIC)

/* Blend */
#undef REG_BLDCNT
#undef REG_BLDALPHA
#undef REG_BLDY
#define REG_BLDCNT _IO_REG16(REG_OFFSET_BLDCNT)
#define REG_BLDALPHA _IO_REG16(REG_OFFSET_BLDALPHA)
#define REG_BLDY _IO_REG16(REG_OFFSET_BLDY)

/* Sound */
#undef REG_SOUND1CNT_L
#undef REG_NR10
#undef REG_SOUND1CNT_H
#undef REG_NR11
#undef REG_NR12
#undef REG_SOUND1CNT_X
#undef REG_NR13
#undef REG_NR14
#undef REG_SOUND2CNT_L
#undef REG_NR21
#undef REG_NR22
#undef REG_SOUND2CNT_H
#undef REG_NR23
#undef REG_NR24
#undef REG_SOUND3CNT_L
#undef REG_NR30
#undef REG_SOUND3CNT_H
#undef REG_NR31
#undef REG_NR32
#undef REG_SOUND3CNT_X
#undef REG_NR33
#undef REG_NR34
#undef REG_SOUND4CNT_L
#undef REG_NR41
#undef REG_NR42
#undef REG_SOUND4CNT_H
#undef REG_NR43
#undef REG_NR44
...
#undef REG_NR52
#undef REG_SOUNDBIAS
#undef REG_SOUNDBIAS_L
#undef REG_SOUNDBIAS_H
#undef REG_WAVE_RAM0
#undef REG_WAVE_RAM1
#undef REG_WAVE_RAM2
#undef REG_WAVE_RAM3
#undef REG_FIFO_A
#undef REG_FIFO_B
#define REG_SOUND1CNT_L _IO_REG16(REG_OFFSET_SOUND1CNT_L)
#define REG_NR10 _IO_REG8(REG_OFFSET_NR10)
#define REG_SOUND1CNT_H _IO_REG16(REG_OFFSET_SOUND1CNT_H)
#define REG_NR11 _IO_REG8(REG_OFFSET_NR11)
#define REG_NR12 _IO_REG8(REG_OFFSET_NR12)
#define REG_SOUND1CNT_X _IO_REG16(REG_OFFSET_SOUND1CNT_X)
#define REG_NR13 _IO_REG8(REG_OFFSET_NR13)
#define REG_NR14 _IO_REG8(REG_OFFSET_NR14)
#define REG_SOUND2CNT_L _IO_REG16(REG_OFFSET_SOUND2CNT_L)
#define REG_NR21 _IO_REG8(REG_OFFSET_NR21)
#define REG_NR22 _IO_REG8(REG_OFFSET_NR22)
#define REG_SOUND2CNT_H _IO_REG16(REG_OFFSET_SOUND2CNT_H)
#define REG_NR23 _IO_REG8(REG_OFFSET_NR23)
#define REG_NR24 _IO_REG8(REG_OFFSET_NR24)
#define REG_SOUND3CNT_L _IO_REG16(REG_OFFSET_SOUND3CNT_L)
#define REG_NR30 _IO_REG8(REG_OFFSET_NR30)
#define REG_SOUND3CNT_H _IO_REG16(REG_OFFSET_SOUND3CNT_H)
#define REG_NR31 _IO_REG8(REG_OFFSET_NR31)
#define REG_NR32 _IO_REG8(REG_OFFSET_NR32)
#define REG_SOUND3CNT_X _IO_REG16(REG_OFFSET_SOUND3CNT_X)
#define REG_NR33 _IO_REG8(REG_OFFSET_NR33)
#define REG_NR34 _IO_REG8(REG_OFFSET_NR34)
#define REG_SOUND4CNT_L _IO_REG16(REG_OFFSET_SOUND4CNT_L)
#define REG_NR41 _IO_REG8(REG_OFFSET_NR41)
#define REG_NR42 _IO_REG8(REG_OFFSET_NR42)
#define REG_SOUND4CNT_H _IO_REG16(REG_OFFSET_SOUND4CNT_H)
#define REG_NR43 _IO_REG8(REG_OFFSET_NR43)
#define REG_NR44 _IO_REG8(REG_OFFSET_NR44)
#define REG_SOUNDCNT_L _IO_REG16(REG_OFFSET_SOUNDCNT_L)
#define REG_NR50 _IO_REG8(REG_OFFSET_NR50)
#define REG_NR51 _IO_REG8(REG_OFFSET_NR51)
#define REG_SOUNDCNT_H _IO_REG16(REG_OFFSET_SOUNDCNT_H)
#define REG_SOUNDCNT_X _IO_REG16(REG_OFFSET_SOUNDCNT_X)
#define REG_NR52 _IO_REG8(REG_OFFSET_NR52)
#define REG_SOUNDBIAS _IO_REG16(REG_OFFSET_SOUNDBIAS)
#define REG_SOUNDBIAS_L _IO_REG8(REG_OFFSET_SOUNDBIAS_L)
#define REG_SOUNDBIAS_H _IO_REG8(REG_OFFSET_SOUNDBIAS_H)
#define REG_WAVE_RAM0 _IO_REG32(REG_OFFSET_WAVE_RAM0)
#define REG_WAVE_RAM1 _IO_REG32(REG_OFFSET_WAVE_RAM1)
#define REG_WAVE_RAM2 _IO_REG32(REG_OFFSET_WAVE_RAM2)
#define REG_WAVE_RAM3 _IO_REG32(REG_OFFSET_WAVE_RAM3)
#define REG_FIFO_A _IO_REG32(REG_OFFSET_FIFO_A)
#define REG_FIFO_B _IO_REG32(REG_OFFSET_FIFO_B)
...
#undef REG_DMA3CNT_L
#undef REG_DMA3CNT_H
#define REG_DMA0SAD _IO_REG32(REG_OFFSET_DMA0SAD)
#define REG_DMA0DAD _IO_REG32(REG_OFFSET_DMA0DAD)
#define REG_DMA0CNT _IO_REG32(REG_OFFSET_DMA0CNT)
#define REG_DMA0CNT_L _IO_REG16(REG_OFFSET_DMA0CNT_L)
#define REG_DMA0CNT_H _IO_REG16(REG_OFFSET_DMA0CNT_H)
#define REG_DMA1SAD _IO_REG32(REG_OFFSET_DMA1SAD)
#define REG_DMA1DAD _IO_REG32(REG_OFFSET_DMA1DAD)
#define REG_DMA1CNT _IO_REG32(REG_OFFSET_DMA1CNT)
#define REG_DMA1CNT_L _IO_REG16(REG_OFFSET_DMA1CNT_L)
#define REG_DMA1CNT_H _IO_REG16(REG_OFFSET_DMA1CNT_H)
#define REG_DMA2SAD _IO_REG32(REG_OFFSET_DMA2SAD)
#define REG_DMA2DAD _IO_REG32(REG_OFFSET_DMA2DAD)
#define REG_DMA2CNT _IO_REG32(REG_OFFSET_DMA2CNT)
#define REG_DMA2CNT_L _IO_REG16(REG_OFFSET_DMA2CNT_L)
#define REG_DMA2CNT_H _IO_REG16(REG_OFFSET_DMA2CNT_H)
#define REG_DMA3SAD _IO_REG32(REG_OFFSET_DMA3SAD)
#define REG_DMA3DAD _IO_REG32(REG_OFFSET_DMA3DAD)
#define REG_DMA3CNT _IO_REG32(REG_OFFSET_DMA3CNT)
#define REG_DMA3CNT_L _IO_REG16(REG_OFFSET_DMA3CNT_L)
#define REG_DMA3CNT_H _IO_REG16(REG_OFFSET_DMA3CNT_H)
...
#undef REG_TM3CNT_L
#undef REG_TM3CNT_H
#define REG_TMCNT(n) _IO_REG32(REG_OFFSET_TMCNT + ((n) * 4))
#define REG_TMCNT_L(n) _IO_REG16(REG_OFFSET_TMCNT_L + ((n) * 4))
#define REG_TMCNT_H(n) _IO_REG16(REG_OFFSET_TMCNT_H + ((n) * 4))
#define REG_TM0CNT _IO_REG32(REG_OFFSET_TM0CNT)
#define REG_TM0CNT_L _IO_REG16(REG_OFFSET_TM0CNT_L)
#define REG_TM0CNT_H _IO_REG16(REG_OFFSET_TM0CNT_H)
#define REG_TM1CNT _IO_REG32(REG_OFFSET_TM1CNT)
#define REG_TM1CNT_L _IO_REG16(REG_OFFSET_TM1CNT_L)
#define REG_TM1CNT_H _IO_REG16(REG_OFFSET_TM1CNT_H)
#define REG_TM2CNT _IO_REG32(REG_OFFSET_TM2CNT)
#define REG_TM2CNT_L _IO_REG16(REG_OFFSET_TM2CNT_L)
#define REG_TM2CNT_H _IO_REG16(REG_OFFSET_TM2CNT_H)
#define REG_TM3CNT _IO_REG32(REG_OFFSET_TM3CNT)
#define REG_TM3CNT_L _IO_REG16(REG_OFFSET_TM3CNT_L)
#define REG_TM3CNT_H _IO_REG16(REG_OFFSET_TM3CNT_H)

/* Serial */
#undef REG_SIOCNT
#undef REG_SIODATA8
#undef REG_SIODATA32
#undef REG_SIOMLT_SEND
#undef REG_SIOMLT_RECV
#undef REG_SIOMULTI0
#undef REG_SIOMULTI1
#undef REG_SIOMULTI2
#undef REG_SIOMULTI3
#define REG_SIOCNT _IO_REG16(REG_OFFSET_SIOCNT)
#define REG_SIODATA8 _IO_REG16(REG_OFFSET_SIODATA8)
#define REG_SIODATA32 _IO_REG32(REG_OFFSET_SIODATA32)
#define REG_SIOMLT_SEND _IO_REG16(REG_OFFSET_SIOMLT_SEND)
#define REG_SIOMLT_RECV _IO_REG64(REG_OFFSET_SIOMLT_RECV)
#define REG_SIOMULTI0 _IO_REG16(REG_OFFSET_SIOMULTI0)
#define REG_SIOMULTI1 _IO_REG16(REG_OFFSET_SIOMULTI1)
#define REG_SIOMULTI2 _IO_REG16(REG_OFFSET_SIOMULTI2)
#define REG_SIOMULTI3 _IO_REG16(REG_OFFSET_SIOMULTI3)

/* Keys */
#undef REG_KEYINPUT
#undef REG_KEYCNT
#define REG_KEYINPUT _IO_REG16(REG_OFFSET_KEYINPUT)
#define REG_KEYCNT _IO_REG16(REG_OFFSET_KEYCNT)
...
#undef REG_IF
#undef REG_WAITCNT
#define REG_RCNT _IO_REG16(REG_OFFSET_RCNT)
#define REG_IME _IO_REG16(REG_OFFSET_IME)
#define REG_IE _IO_REG16(REG_OFFSET_IE)
#define REG_IF _IO_REG16(REG_OFFSET_IF)
#define REG_WAITCNT _IO_REG16(REG_OFFSET_WAITCNT)

#endif /* PC_PORT */ // I/O register fields
