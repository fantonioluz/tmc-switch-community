...
#ifdef PC_PORT
    // The native linker can reorder/discard gUnk_080046A4End. Keep the
    // terminator inside the array so lookups cannot enter unrelated tables.
    { 0, 0 },
#endif
};
...
#ifdef PC_PORT
const u32 gTileInteractionDefinitionCount = ARRAY_COUNT(gUnk_080047F6) / 4;
#endif
