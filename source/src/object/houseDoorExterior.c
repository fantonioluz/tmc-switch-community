...
void HouseDoorExterior(HouseDoorExteriorEntity* this) {
     ...
     * the parent's room-property iteration reads garbage bytes. */
...
#ifdef PC_PORT
    /* Room properties 0..7 are the standard entity/tile/callback lists.
     * Exterior-door tables are additional properties and start at index 8.
     * Never interpret an entity list as 12-byte door records: doing so
     * produces doors at arbitrary map coordinates. */
    {
